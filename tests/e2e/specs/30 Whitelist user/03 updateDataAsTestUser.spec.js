import { testProducts, testDepartment, testObjective, testKeyResult, testPeriod } from '../../config';
...
describe('Verifies restrictions for test user', () => {
  ...
  it('Verifies contents on product page (Product One)', () => {
    ...
    cy.get('[data-cy="mission_statement"]').should('contain', testProducts[0].mission_statement);
  ...
  it('Verifies the changed Product', () => {
    ...
    cy.get('[data-cy="mission_statement"]').should('contain', testProducts[0].edited_mission_statement);
  });
  ...
  it('Cannot edit Product two', () => {
    ...
    cy.get('[data-cy="mission_statement"]').should('contain', testProducts[1].mission_statement);
