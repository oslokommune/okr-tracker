...
export function loggedIn(user) {
  show(i18n.tc('toaster.welcome', null, { user: user.name ? user.name : '' }));
}
...
export function createdDocument() {
  show(i18n.tc('toaster.add.document'));
}
...
export function requestAccepted(user) {
  return show(i18n.tc('toaster.request.accepted', null, { user }));
}

export function requestRejected(user) {
  return show(i18n.tc('toaster.request.rejected', null, { user }));
}
