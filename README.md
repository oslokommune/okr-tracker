...
OKR-tracker supports for the time being only three login providers: Google, email/pass. If you are looking for other providers that firebase support, we would love for you to open up a PR with the needed changes.
