...
- Migrated from the deprecated `gsutil` tool to `gcloud`.
...
- Fixed product creation for organization admins.

### Security

- Require authentication for reading slugs.
- Updated dependencies to address potential security vulnerabilities.
...
- Upgraded from Vite 5 to Vite 6 for building.
- Added a new role "product lead".
